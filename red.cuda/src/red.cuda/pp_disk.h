...
public:
	...
	*/
	...
	bool check_for_close_encounter(bool inner_steps);
	...
	*/
	...
	bool_t		close_encounter;			//if true, collisions are disabled
	bool_t		inner_steps;				//if true, collisions and close encounters are detected between steps
