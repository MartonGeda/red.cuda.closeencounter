...
for i = 1:3
   if i == 1
    ...
    p(2) = 0.95;
    set(lh,'Position',p);
    annotation('textbox',[0.151 0.854 0.294 0.026],'Color','b','String',sprintf('a = %1.3f, e = %1.3f, i = %1.1f, w = %1.3f, Om = %1.1f, M = %1.3f',oe1(ii(1),1),oe1(ii(1),2),oe1(ii(1),3),oe1(ii(1),4),oe1(ii(1),5),oe1(ii(1),6)),'LineStyle','none','FitBoxToText','off','HorizontalAlignment','center','Tag','oe');
    annotation('textbox',[0.151 0.834 0.294 0.026],'Color','r','String',sprintf('a = %1.3f, e = %1.3f, i = %1.1f, w = %1.3f, Om = %1.1f, M = %1.3f',oe2(ii(1),1),oe2(ii(1),2),oe2(ii(1),3),oe2(ii(1),4),oe2(ii(1),5),oe2(ii(1),6)),'LineStyle','none','FitBoxToText','off','HorizontalAlignment','center','Tag','oe');
    ...
    suptitle(sprintf('time t = %5.2f day, time of event \\Deltat = %1.3f day',t(ii(1)),timeofce(i)));  
